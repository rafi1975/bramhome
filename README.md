...
8. On the new tab, click **Connect & install** and choose the dongle's serial port. When it says **Installed and rebooting**, unplug USB, plug the dongle into the meter, and wait for the LED to turn green.
